...
class Event
{
    public $eventID;
    public $topic_user;
    public $topic;// topic => list_OF_user_objects ;; assoc array with topics as key and value as an array of user object
    public $topic_frequency;
    public $location;// topic => no_of_users assoc array with topics as key and value as a int representing the number of students choosing that topic
    public $start_time;
    public $end_time;
    public $course;
    public $course_id;//course object
    public $ta_name;
    public $ta;
    public $feedback_id;//ta Object
    public $user;
    private $mysqli;//contains arrays of users object
